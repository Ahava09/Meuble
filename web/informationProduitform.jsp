...
%>
    ...
    <body>
        <div class="container">
            ...
            <form action="InformationProduitServlet" method="post">
                ...
                <input type="number" name="prix" placeholder="Prix de Vente" required><br>
                <input type="datetime-local" name="datedebut" placeholder="Debut" required><br>
                <input type="datetime-local" name="datefin" placeholder="Fin" required><br>
