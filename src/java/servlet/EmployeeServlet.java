...
public class EmployeeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            request.setAttribute("postes", new Poste().getAll(connectBD.getOnConnection()));
            request.setAttribute("employee", new Employee().getAll(connectBD.getOnConnection()));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Employee emp = new Employee(nom, prenoms, dtn, dateDebut, poste,salaire);
            emp.insert(connectBD.getOnConnection());
