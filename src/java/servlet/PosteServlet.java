...
public class PosteServlet extends HttpServlet {
    ConnectBD connectionBD = new ConnectBD();
    /**
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        poste.setNom(request.getParameter("poste"));
        poste.setSalaire(request.getParameter("prix"));
        try {
            poste.insert(connectionBD.getOnConnection());
