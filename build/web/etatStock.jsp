...
<%@page import="model.EtatStock"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%@page import="java.util.ArrayList"%>
<%
    ArrayList<EtatStock> mv = (ArrayList<EtatStock>)request.getAttribute("etat");
                    ...
                    <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="index.html">
                        ...
                        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto pt-2 pt-lg-0">
                                <li > <a class="btn btn-lg btn-primary rounded-pill hover-top" href="Filtre" role="button">Filtre</a> </li>
                                ...
                                <li > <a class="btn btn-lg btn-primary rounded-pill hover-top" href="ajoutMatiereStyle" role="button">AddMatiereStyle</a>
                                <li > <a class="btn btn-lg btn-primary rounded-pill hover-top" href="DetailsDataServlet" role="button">AddQuantiteMatiereStyle</a></li>
                                <li > <a class="btn btn-lg btn-primary rounded-pill hover-top" href="InformationDataServlet" role="button">Informations Produits</a></li>
                            </ul>
                    ...
                    <div class="container position-relative">
                        <div class="row align-items-center py-8">
                            ...
                            <div class="col-md-7 col-lg-6 text-center text-md-start"><span class="badge bg-light rounded-pill text-dark align-items-center d-flex flex-row-reverse justify-content-end mx-auto mx-md-0 ps-0 w-75 w-sm-50 w-md-75 w-xl-50 mb-3">#1 des meilleurs apks de vente<img class="img-fluid float-start me-3" src="assets/img/illustrations/arrow-right.png" alt=""/></span>
                                <form action="EtatStockServletc" method="post">
                                ...
                                <table  class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><%= mv.get(i).getMatiere().getNom()%></td>
                                            <td><%= mv.get(i).getQuantite()%></td>
                                            <td><%= mv.get(i).getUnite()%></td>
                                        </tr>
                                        <% } %>
                                    </tbody>
                                </table>
